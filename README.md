...
- **Выбор сервиса**: переключение между Drive, Samokaty и Prokat
...
2. **Настройте переменные окружения:**
   ...
   - `WEBHOOK_PROKAT` - URL вебхука для Prokat
   - `WEBHOOK_DRIVE_TEXT` / `WEBHOOK_SAMOKATY_TEXT` / `WEBHOOK_PROKAT_TEXT` — текстовые вебхуки
...
| `WEBHOOK_SAMOKATY` | URL вебхука для Samokaty | - |
| `WEBHOOK_PROKAT` | URL вебхука для Prokat | - |
| `WEBHOOK_DRIVE_TEXT` | Текстовый вебхук для Drive | - |
| `WEBHOOK_SAMOKATY_TEXT` | Текстовый вебхук для Samokaty | - |
| `WEBHOOK_PROKAT_TEXT` | Текстовый вебхук для Prokat | - |
